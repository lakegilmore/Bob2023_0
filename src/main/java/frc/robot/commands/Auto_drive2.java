...
public class Auto_drive2 extends SequentialCommandGroup {
  /** Creates a new Auto_drive2. */
  public Auto_drive2(DriveTrain m_DriveTrain, Arm m_arm, LongExtend m_longextend, ShortExtend m_shortextend, Gripper m_gripper) {
 ...
 // new  ArmDistance(.1, -1, m_arm),
  new ArmRun(1, m_arm).withTimeout(1.8),
  new DriveDistance(120, -.75, -.75, m_DriveTrain)
